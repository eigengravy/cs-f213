...
// ---------------------------------------------------------------------------------
        ...
        {
            System.out.println("1canGetBook() in BookStore is Wrong");
            cgbbs = true;
        }
        ...
        {
            System.out.println("5canGetBook() in BookStore is Wrong");
            cgbbs = true;
        }
        if(bs1.getBooks().length != 1 || bs1.getIncome() != 250 || !bs1.getBooks()[0].equals(bs1book3))
        {
            System.out.println("6canGetBook() in BookStore is Wrong");
            cgbbs = true;
        }
        if(bs1.canGetBook(pkbs3, bs1book2))
        {
            System.out.println("7canGetBook() in BookStore is Wrong");
            cgbbs = true;
        }
        if(cgbbs)
        {
        ...
        {
            System.out.println("1canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(!ngo1.canGetBook(ukngo1, ngo1book3))
        {
            System.out.println("2canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(ngo1.getBooks().length != 2 || ngo1.getItemCount() != 2 || !ngo1.getBooks()[0].equals(ngo1book2) || !ngo1.getBooks()[1].equals(ngo1book1))
        {
            System.out.println("3canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(!ngo1.canGetBook(ukngo1, ngo1book1))
        {
            System.out.println("4canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(ngo1.getBooks().length != 1 || ngo1.getItemCount() != 1 || !ngo1.getBooks()[0].equals(ngo1book2))
        {
            System.out.println("5canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(!ngo1.canGetBook(ukngo1, ngo1book2))
        {
            System.out.println("6canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(ngo1.getBooks().length != 0 || ngo1.getItemCount() != 0)
        {
            System.out.println("7canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(ngo1.canGetBook(ukngo1, ngo1book2))
        {
            System.out.println("8canGetBook() in NGO is Wrong");
            cbgngo = false;
        }
        if(!cbgngo)
        {
