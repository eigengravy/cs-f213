public interface LibraryInterface 
{
    ...
    // Any book can be added to a BookStore
    // BUT 
    // When we add a book to an NGO, it is bought using the budget of the NGO, and the NGO should have enough budget to add a book
